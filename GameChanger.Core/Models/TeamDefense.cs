...
namespace GameChanger.Core
{
    ...
    {
        public TeamDefense defense { get; set; }
        public TeamGeneral general { get; set; }
        public TeamOffense offense { get; set; }
    }
    ...
    public class PlayerStats
    {
        ...
        public PlayerDefense defense { get; set; }
        public PlayerGeneral general { get; set; }
        public PlayerOffense offense { get; set; }
    }
    
    public class StatsData
    {
        public TeamStats stats { get; set; }
        public Dictionary<string, Something> players { get; set; }
    }
    ...
    public class PlayerDefense
    {
        ...
        [JsonPropertyName("outs:C")]
        public int DefenseOutsC { get; set; }
    ...
    public class PlayerOffense
    {
        ...
        [JsonPropertyName("6+%")]
        public double Defense_6 { get; set; }
        public double AVG { get; set; }
        ...
        [JsonPropertyName("SW%")]
        public double DefenseSW { get; set; }
        public int XBH { get; set; }
        ...
        [JsonPropertyName("QAB%")]
        public double DefenseQAB { get; set; }
        public int WEAK { get; set; }

        [JsonPropertyName("2S+3%")]
        public double Defense2S3 { get; set; }
        public double BABIP { get; set; }
        public int HRISP { get; set; }
